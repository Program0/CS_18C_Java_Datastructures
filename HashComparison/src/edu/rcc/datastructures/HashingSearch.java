...
public class HashingSearch<Key extends Comparable<? super Key>, Value extends Comparable<? super Value>> {
	// Minimum table size
	...
	private void resize(int newSize) {
		...
		if (newSize > MINIMUM) {
			HashingSearch<Key, Value> tempTable = new HashingSearch<Key, Value>(
					newSize);
			for (int i = 0; i < hashTable.length; i++) {
				{
